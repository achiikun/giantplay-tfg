...
class Quaternion2:
    ...
    def _multiply_with_quaternion(self, q2):
        ...
        result = Quaternion2.from_value(np.array((w, x, y, z)))
        return result

    def _multiply_with_vector(self, v):
        q2 = Quaternion2.from_value(np.append((0.0), v))
...
if __name__ == '__main__':
    q = Quaternion(axis=[0,0,1], radians=np.pi/2)
    q2 = Quaternion(axis=[0,0,1], radians=np.pi/2)
    v = np.array([1,0,0])
